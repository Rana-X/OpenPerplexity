      ...
      <div>
        ...
        {loading ? (
          ...
          <div className="flex flex-col gap-4 pb-28 pt-5 lg:pb-8 w-full">
            {discover?.length === 0 && (
              <div className="flex min-h-[40vh] items-center justify-center rounded-3xl border border-light-200 dark:border-dark-200 bg-light-secondary/40 dark:bg-dark-secondary/40 text-black/60 dark:text-white/60">
                No stories available right now. Try again in a moment.
              </div>
            )}
