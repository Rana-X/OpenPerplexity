    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col space-y-9 lg:space-y-0 lg:flex-row lg:justify-between lg:space-x-9">
        ...
        >
          ...
          {section.message.status === 'error' && !hasContent && (
            <div className="flex items-start gap-2 rounded-lg border border-amber-200 bg-amber-50 p-3 text-sm text-amber-900 dark:border-amber-500/40 dark:bg-amber-500/10 dark:text-amber-100">
              <CircleAlert className="mt-0.5 h-4 w-4 shrink-0" />
              <span>
                Search failed before a final answer was generated. Retry the
                query now that the search backend is up again.
              </span>
            </div>
          )}
