    ...
    <div className="w-[95vw] md:w-[80vw] lg:w-[65vw] mx-auto px-2 sm:px-4 md:px-6 flex flex-col space-y-6">
      {setupState === 2 && (
        <motion.div
          ...
          className="w-full h-[calc(95vh-80px)] rounded-[2rem] border border-light-200 bg-light-primary/90 flex flex-col overflow-hidden backdrop-blur-xl dark:border-dark-200 dark:bg-dark-primary/90"
        >
            ...
            <div className="flex flex-row justify-between items-center mb-4 md:mb-6 pb-3 md:pb-4 border-b border-light-200 dark:border-dark-200">
              <div>
                ...
                <p className="text-[10px] sm:text-xs text-black/50 dark:text-white/50 mt-0.5">
                  Add the providers OpenPerplexity can call during research.
                </p>
              </div>
              <AddProvider
              ...
              {isLoading ? (
                ...
                <div className="flex flex-col items-center justify-center py-8 md:py-12 text-center">
                  ...
                  <p className="text-[10px] sm:text-xs text-black/50 dark:text-white/50 mt-1">
                    Add a provider above to unlock chat models and embeddings.
                  </p>
                </div>
              ) : (
          ...
          <div className="flex-1 overflow-y-auto px-3 sm:px-4 md:px-6 py-4 md:py-6">
            <div className="flex flex-row justify-between items-center mb-4 md:mb-6 pb-3 md:pb-4 border-b border-light-200 dark:border-dark-200">
              <div>
                ...
                <p className="text-[10px] sm:text-xs text-black/50 dark:text-white/50 mt-0.5">
                  Choose the chat and embedding models used by default.
                </p>
              </div>
            </div>
      ...
      <div className="flex flex-row items-center justify-between pt-2">
        ...
        {setupState === 2 && (
          <motion.button
            ...
            className="flex flex-row items-center gap-1.5 md:gap-2 px-3 md:px-5 py-2 md:py-2.5 rounded-full bg-[linear-gradient(135deg,#2563eb,#14b8a6)] text-white shadow-[0_14px_28px_rgba(37,99,235,0.2)] hover:opacity-90 active:scale-95 transition-all duration-200 font-medium text-xs sm:text-sm disabled:bg-light-200 dark:disabled:bg-dark-200 disabled:text-black/40 dark:disabled:text-white/40 disabled:cursor-not-allowed disabled:active:scale-100"
          >
            <span>Next</span>
